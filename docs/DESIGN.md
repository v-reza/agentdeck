...
colors:
  ...
  status-awaiting-approval: "#7c3aed"
  ...
  on-status-backlog: "#64748b"
  on-status-ready: "#2563eb"
  on-status-running: "#d97706"
  on-status-awaiting-approval: "#7c3aed"
  on-status-blocked: "#ea580c"
  on-status-review: "#0891b2"
  on-status-done: "#16a34a"
  on-status-failed: "#dc2626"
  on-status-cancelled: "#94a3b8"
  on-status-archived: "#cbd5e1"
