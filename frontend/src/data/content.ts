...
export type Milestone = {
  ...
  state: string
  /**
   * Which milestone the roadmap marks as in flight. It is data, not a rule
   * derived from the id: the marker used to be `id === 'M0'` in the component,
   * so M0 stayed highlighted as "current" long after it shipped.
   */
  current?: boolean
  title: string
  copy: string
